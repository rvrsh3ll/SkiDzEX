namespace Confuser.Protections.MildReferenceProxy
{
    ...
    internal abstract class RPMode
    {
        ...
        protected static TypeDef GetDelegateType(RPContext ctx, MethodSig sig)
        {
            ...
            {
                def = new TypeDefUser(ctx.Name.ObfuscateName((string) ctx.Method.DeclaringType.Namespace, RenameMode.Sequential), ctx.Name.RandomName(), ctx.Module.CorLibTypes.GetTypeRef("System", "MulticastDelegate")) {
