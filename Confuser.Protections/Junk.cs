...
namespace Confuser.Protections
{
	...
	internal class Junk : Protection
	{
		...
		{
			pipeline.InsertPreStage(PipelineStage.WriteModule, new Junk.JunkDumpPhase(this));
		}
		...
		private class JunkDumpPhase : ProtectionPhase
		{
			...
			public JunkDumpPhase(Junk parent) : base(parent)
			{
			}
